...
##选集规则
var 标识=e2Rex(getVar("源码"),".ty(HNF_GLOBAL_INIT)").match(/"sStreamName":"(.+?)"/)[1];var 分类=[];var a={};var data=[];data.push({name:"EPG线路",url:"http://cn.egwang186.top:35455/huya/"+getVar("地址").split("huya.com/")[1]},{name:"php线路",url:"http://cn.egwang186.top:39000/huya.php?id="+getVar("地址").split("huya.com/")[1]},{name:"Txdirect.hls线路",url:"https://aldirect.hls.huya.com/huyalive/"+标识+".m3u8"},{name:"Tx.hls线路",url:"https://tx.hls.huya.com/huyalive/"+标识+".m3u8"});a.data=data;a.title="线路";分类.push(a);var 分类=e2Arr(JSON.stringify(分类),".json()");var 线路="";var 简介=e2Rex(getVar("name"),".t()");var 列表规则=".json(data)";var 标题规则=".json(title)";var 选集规则=".json(name)";var 选集地址规则=".json(url)";
##搜索规则
