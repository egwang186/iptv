...
if(!列表[0]){var 列表=["网页可能有搜索验证，去网页看看吧"];var 标题规则=".t()";var 地址规则=getVar("当前请求地址");var 图片规则=".get(img).a(data-original)";var 简介规则="长按网页打开，验证后返回重新搜索即可";var 图片底部规则="";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";}else{if(getVar("翻页")){var page=Number(getVar("翻页")>列表.length?0:getVar("翻页"))-1;}else{var page=Math.floor(Math.random() * (列表.length - 0 + 1)) + 0;}var 列表=列表[page].match(/\{"img".+?\}/g);var 标题规则=".json(name)";var 地址规则=".c(https://www.histar.tv/live/).json(url)";var 图片规则=".json(img)";var 简介规则=".json(url)";var 图片底部规则="";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";}
##筛选数据
...
if(Number(getVar("翻页"))==1){
    var 列表=e2Arr(getHttp(JSON.stringify({url:getVar("baseURL"),head:{"User-Agent":"Mozilla/5.0","Accept-Language": "zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7"}})),".get(div.post-list)");if(!列表[0]){var 列表=["网页可能有搜索验证，去网页看看吧"];var 标题规则=".t()";var 地址规则=getVar("当前请求地址");var 图片规则=".get(img).a(data-original)";var 简介规则="长按网页打开，验证后返回重新搜索即可";var 图片底部规则="";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";}else{var 标题规则=".get(a).t()";var 地址规则=".c(http://player.tingfm.com/?id=).get(a).a(href).z(\\d+)";var 图片规则="@js='res://tv.jpg';";var 简介规则=".get(a).t()";var 图片底部规则="";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";}
}else{
    var 列表=e2Arr(getHttp(JSON.stringify({url:"https://tingfm.com/wp-json/query/wnd_posts?is_main_query=true&type=radio&without_content=true&paged="+(Number(getVar("翻页"))-1)+"&update_post_term_cache=false&update_post_meta_cache=false&posts_per_page=30",head:{"User-Agent":"Mozilla/5.0","Accept-Language": "zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7"}})),".json(data).json(posts)");var 标题规则=".json(post_title)";var 地址规则=".c(http://player.tingfm.com/?id=).json(ID)";var 图片规则="@js='res://tv.jpg';";var 简介规则=".json(post_modified)";var 图片底部规则="";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";
}
##筛选数据
