...
"翻页"+b;
##免嗅探规则
var id=getVar("地址").match(/\/(\d+?)-/)[1];var ad=getVar("地址").match(/(http.+?)\//)[1];var code=JZ(JSON.stringify({url:ad+"/api.php/provide/vod/?ac=videolist&ids="+id,head:{"Cookie":getVar("本网页cookie")}}));
