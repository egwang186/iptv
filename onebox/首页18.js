...
##选集规则
var 分类=e2Arr(getVar("源码"),".all()");var 简介=getVar("标题");var 线路="";var 列表规则=".json(zhubo)";var 标题规则=getVar("标题");var 选集规则=".json(title)";var 选集地址规则="@js=\"http://ip111.cn/?wd=\"+列表[j].replace(/\\?/g,\"幻魔快修\");";
##搜索规则
