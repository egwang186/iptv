...
if(getVar("地址").indexOf("$$")!=-1){
    ...
    if(类型=="audio"){
        ...
        if(播放模式=="全部"||播放模式=="null"){
            ...
            var 转码2K会员专享=域名+'/apis/my-yun-play/'+xinfile_id+'/'+odrive_id+'/'+access_token+'/QHD/index.m3u8';
            var 转码720=域名+'/apis/my-yun-play/'+xinfile_id+'/'+odrive_id+'/'+access_token+'/HD/index.m3u8';
            var 播放模式=getVar("播放模式")||"全部";
            if(播放模式=="全部"||播放模式=="null"){
