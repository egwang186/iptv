...
if(getVar("地址").indexOf("$$")!=-1){
    ...
    if(JSON.parse(code).audio_template_list){
        ...
        var 转码HQ='http://59.47.74.33:3000/apis/yun-audio/'+file_id+'/'+share_id+'/'+access_token+'/'+share_token+'/HQ/master.mp3';
        ...
        if(播放模式=="全部"||播放模式=="null"){
         ...
         //var rz=JZ(JSON.stringify({url:JSON.parse(code).download_url,redirect:false,head:{"Referer":"https://www.aliyundrive.com/","User-Agent":"Aliapp(AYSD/4.1.2)","Authorization":access_token}}));
            ...
            //var 转码1080='http://59.47.74.33:3000/apis/yun-play/'+share_id+'/'+file_id+'/'+access_token+'/'+share_token+'/FHD/'+mydrive_id+'/'+user_id+'/'+device_id+'/index.m3u8';
            ...
            var 播放模式=getVar("播放模式")||"全部";
            if(播放模式=="全部"||播放模式=="null"){
                JSON.stringify([{name:"新原画",url:JSON.parse(code).url,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"原画",url:JSON.parse(code).download_url,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"本地高画质转码(会员2K)",url:本地转码2K会员专享,head:{"Referer":"https://www.aliyundrive.com/"}},{name:"720P转码",url:转码720,head:{"Referer":"https://www.aliyundrive.com/"}},{name:"高画质转码(会员2K)",url:转码2K会员专享,head:{"Referer":"https://www.aliyundrive.com/"}}]);
            }else if(播放模式=="本地转码"){
                JSON.stringify([{name:"新原画",url:JSON.parse(code).url,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"原画",url:JSON.parse(code).download_url,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"本地高画质转码(会员2K)",url:本地转码2K会员专享,head:{"Referer":"https://www.aliyundrive.com/"}}]);
            }else{
...
var HEAD=JSON.stringify({"Authorization":access_token});
    ...
    var 转码HQ='http://59.47.74.33:3000/apis/my-yun-audio/'+file_id+'/'+drive_id+'/'+access_token+'/'+user_id+'/'+device_id+'/LQ/master.mp3';
    ...
    JSON.stringify([{name:"原始文件",url:JSON.parse(xincode).items[0].download_url,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"LQ低音质转码",url:转码HQ,head:{"Referer":"https://www.aliyundrive.com/"}},{name:"本地LQ低音质转码",url:本地转码HQ,head:{"Referer":"https://www.aliyundrive.com/"}}]);
        ...
        var drive_id=getVar("地址").split("?wd=")[1].split("###")[1];
        var u=getVar("地址").split("?wd=")[1].split("###")[0];
        //var code=getHttp(JSON.stringify({url:"https://api.aliyundrive.com/adrive/v1/file/get_path",postJson:JSON.stringify({drive_id:mydrive_id,file_id:file_id}),head:JSON.parse(HEAD)}));
        //alert(code)
        ...
        //var 云端原画='http://59.47.74.33:3000/apis/down-url/'+file_id+'/'+drive_id+'/'+access_token+'/'+user_id+'/'+device_id+'/index.m3u8';
        ...
        var 播放模式=getVar("播放模式")||"全部";
            if(播放模式=="全部"||播放模式=="null"){
                JSON.stringify([{name:"新原画",url:JSON.parse(新原画code).url,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"原画",url:playurl,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"本地高画质转码",url:本地高画质转码,head:{"Referer":"https://www.aliyundrive.com/"}},{name:"720P转码",url:转码720,head:{"Referer":"https://www.aliyundrive.com/"}},{name:"高画质转码",url:高画质转码,head:{"Referer":"https://www.aliyundrive.com/"}}]);
            }else if(播放模式=="本地转码"){
                JSON.stringify([{name:"新原画",url:JSON.parse(新原画code).url,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"原画",url:playurl,head:{"Authorization":access_token,"Referer":"https://www.aliyundrive.com/"}},{name:"本地高画质转码",url:本地高画质转码,head:{"Referer":"https://www.aliyundrive.com/"}}]);
            }else{
